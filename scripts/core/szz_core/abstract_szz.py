...
from scripts.core.szz_core.options import Options
# from scripts.core.szz_core.comment_parser import CommentParser
from scripts.core.szz_core.comment_parser import parse_comments
